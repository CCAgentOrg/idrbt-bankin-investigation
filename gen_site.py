...
ALL_LANGS = {
    ...
    "bn": {
            "tag": "নিরাপত্তা তদন্ত",
            "h1": "IDRBT .bank.in: বিশ্বাসের ভিত্তি থেকে তথ্য ফাঁস",
            "byline": "লিখেছেন <strong>CashlessConsumer</strong> · <span class=\"date\">28 জুন 2026</span>",
            "subtitle": "33+ অননুমোদিত API এন্ডপয়েন্ট 5,576 ব্যাংক কর্মচারীর শংসাপত্র এক বছরেরও বেশি সময় ধরে প্রকাশ করেছে।",
            "lead": "ভারতের .bank.in ছিল RBI-এর ফ্ল্যাগশিপ অ্যান্টি-ফিশিং উদ্যোগ - একটি ডোমেইন প্রত্যয় যা নাগরিকরা নির্ভর করতে পারে এমন একটি বিশ্বাসের ভিত্তি হওয়ার কথা ছিল। পরিবর্তে, এই ব্যাংকিং ডোমেইনগুলি ইস্যু করে যে পোর্টালটি, তা তার কাছে থাকা প্রতিটি শংসাপত্র ফাঁস করেছে।",
            "p1": "IDRBT ডোমেইন নিবন্ধন পোর্টাল (registrar.idrbt.ac.in) - ভারতের .bank.in নামস্থানের একমাত্র নিবন্ধনকারী - 33+ অননুমোদিত এন্ডপয়েন্টের মাধ্যমে তার সম্পূর্ণ REST API উন্মুক্ত করেছে। curl সহ যে কেউ 5,576 ব্যাংক কর্মচারীর bcrypt পাসওয়ার্ড হ্যাশ, মোবাইল নম্বর, ইমেল ঠিকানা, লগইন আইপি সংগ্রহ করতে পারত।",
            "p2": "পোর্টালটি IKCON টেকনোলজিস দ্বারা কোনো পাবলিক টেন্ডার ছাড়াই নির্মিত হয়েছিল, যা IDRBT-এর ক্রয় নির্দেশিকা লঙ্ঘন করে। IKCON কর্মচারীদের 22টি অ্যাকাউন্ট ছিল, যার মধ্যে 3টি সুপার অ্যাডমিন অ্যাক্সেস সহ।",
            "callout_text": "CERT-In-এ রিপোর্ট করা হয়েছে (8 জুন, 05:30 UTC) এবং IDRBT দ্বারা 25 জুন, 2026-এ ঠিক করা হয়েছে। এন্ডপয়েন্টগুলি আর অ্যাক্সেসযোগ্য নয়।",
            "eli5": ".bank.in হল RBI ব্যাংকের ওয়েবসাইটে দেওয়া একটি বিশেষ তালার মতো। এই তদন্তে দেখা গেছে যে তালা প্রস্তুতকারকের সিস্টেম সমস্ত চাবি ফাঁস করছিল।",
            "h2_data": "ওপেন ডেটা",
            "h2_links": "লিংক",
            ...
            "about_title": "CashlessConsumer",
            "about_text": "ভারতের ডিজিটাল পেমেন্ট শিল্প ট্র্যাকিং করা একটি ভোক্তা সমষ্টি, যা সচেতনতা সংস্থান, প্রযুক্তিগত বিশ্লেষণ, ওপেন ডেটা এবং নীতি ইনপুট তৈরি করে।",
            "about_ref": "পূর্ববর্তী কাজ: KillerLoanApps · BFIL Consent Scam · Fintech Governance RTI Program",
            "about_links": "cashlessconsumer.in · নিউজলেটার · GitHub",
            "footer": "দায়িত্বশীল প্রকাশের অধীনে প্রকাশিত। © জুন 2026। প্রতিবেদন: Srikanth L, CashlessConsumer।",
            "label": "বাংলা",
            "trans_d": "⚠️ AI-generated translation. English original is authoritative."
        },
    "mr": {
            ...
            "byline": "<strong>CashlessConsumer</strong> · <span class=\"date\">28 जून 2026</span>",
            "subtitle": "33+ अनधिकृत API एंडपॉइंट्सनी एक वर्षापेक्षा जास्त काळ 5,576 बँक कर्मचाऱ्यांची क्रेडेन्शियल्स उघडकीस आणली.",
            "lead": "भारताचे .bank.in हे RBI चे प्रमुख अँटी-फिशिंग उपक्रम होते — एक डोमेन प्रत्यय जो नागरिक विश्वासाने वापरू शकतील असा आधारस्तंभ म्हणून होता. पण याउलट, ही बँकिंग डोमेन जारी करणाऱ्या पोर्टलने स्वतःकडील सर्व क्रेडेन्शियल्स गळती केल्या.",
            "p1": "IDRBT डोमेन नोंदणी पोर्टल (registrar.idrbt.ac.in) — भारताच्या .bank.in नेमस्पेससाठी अनन्य नोंदणीकर्ता — 33+ अनधिकृत एंडपॉइंट्सद्वारे त्याचे संपूर्ण REST API उघडे ठेवले. कोणीही curl वापरून सर्व 5,576 बँक कर्मचाऱ्यांचे bcrypt पासवर्ड हॅशेस, मोबाइल क्रमांक, ईमेल पत्ते, लॉगिन IP पत्ते मिळवू शकले.",
            "p2": "हे पोर्टल IKCON टेक्नॉलॉजीजने कोणत्याही सार्वजनिक निविदेशिवाय बांधले, IDRBT च्या खरेदी हँडबुकचे उल्लंघन करून. IKCON कर्मचाऱ्यांकडे 3 सुपर अॅडमिन प्रवेशासह 22 खाती होती.",
            "callout_text": "CERT-In ला कळवले (जून 8, 05:30 UTC) आणि IDRBT ने 25 जून 2026 रोजी दुरुस्त केले. एंडपॉइंट्स यापुढे प्रवेशयोग्य नाहीत.",
            "eli5": ".bank.in म्हणजे RBI ने बँक वेबसाइट्सवर लावलेले एक विशेष कुलूप आहे. या तपासात असे आढळले की कुलूप बनवणाऱ्याची प्रणाली सर्व चाव्या गळती करत होती.",
            "h2_data": "उघडा डेटा",
            "h2_links": "दुवे",
            "dl_report": "📄 पूर्ण अहवाल डाउनलोड करा (PDF)",
            "dl_open": "📦 उघडा डेटा आणि डेटासेट्स",
            "ln_code": "💻 स्रोत कोड",
            "ln_audit": "🔍 दैनिक ऑडिट फीड",
            "ln_archive": "📋 पुरावा संग्रह",
            "about_title": "CashlessConsumer",
            "about_text": "भारताच्या डिजिटल पेमेंट्स उद्योगाचा मागोवा घेणारा, जागरूकता संसाधने, तांत्रिक विश्लेषण, उघडा डेटा आणि धोरणात्मक इनपुट तयार करणारा एक ग्राहक समूह.",
            "about_ref": "मागील काम: KillerLoanApps · BFIL Consent Scam · Fintech Governance RTI Program",
            "about_links": "cashlessconsumer.in · न्यूजलेटर · GitHub",
            "footer": "जबाबदार प्रकटीकरण अंतर्गत प्रकाशित. © जून 2026. अहवाल: Srikanth L, CashlessConsumer.",
            "label": "मराठी",
            "trans_d": "⚠️ AI-generated translation. English original is authoritative."
        },
    "te": {
            "tag": "భద్రతా దర్యాప్తు",
            "h1": "IDRBT .bank.in: ట్రస్ట్ యాంకర్ నుండి డేటా లీక్ వరకు",
            "byline": "<strong>CashlessConsumer</strong> &middot; <span class=\"date\">28 జూన్ 2026</span>",
            "subtitle": "33+ అనథెంటికేటెడ్ API ఎండ్‌పాయింట్లు 5,576 బ్యాంక్ ఉద్యోగుల క్రెడెన్షియల్స్‌ను ఒక సంవత్సరానికి పైగా బహిర్గతం చేశాయి.",
            "lead": "భారతదేశపు .bank.in అనేది RBI యొక్క ఫ్లాగ్‌షిప్ యాంటీ-ఫిషింగ్ చొరవ — పౌరులు నమ్మదగిన ట్రస్ట్ యాంకర్‌గా ఉండాల్సిన డొమైన్ సఫిక్స్. బదులుగా, ఈ బ్యాంకింగ్ డొమైన్‌లను జారీ చేసే పోర్టల్ తన వద్ద ఉన్న ప్రతి క్రెడెన్షియల్‌ను లీక్ చేసింది.",
            "p1": "IDRBT డొమైన్ రిజిస్ట్రేషన్ పోర్టల్ (registrar.idrbt.ac.in) — భారతదేశపు .bank.in బ్యాంకింగ్ నేమ్‌స్పేస్ కోసం ప్రత్యేక రిజిస్ట్రార్ — 33+ అనథెంటికేటెడ్ ఎండ్‌పాయింట్ల ద్వారా తన మొత్తం REST APIని బహిర్గతం చేసింది. curl ఉన్న ఎవరైనా 5,576 మంది బ్యాంక్ ఉద్యోగుల bcrypt పాస్‌వర్డ్ హ్యాష్‌లు, మొబైల్ నంబర్లు, ఇమెయిల్ చిరునామాలు, లాగిన్ IPలు మరియు డివైస్ ఫింగర్‌ప్రింట్‌లను తిరిగి పొందవచ్చు — ఈ ఉద్యోగులందరూ భారతదేశపు బ్యాంకింగ్ డొమైన్‌లను నిర్వహించే బాధ్యత కలిగినవారు.",
            "p2": "ఈ పోర్టల్‌ను IKCON టెక్నాలజీస్ ఎటువంటి పబ్లిక్ టెండర్ లేకుండా నిర్మించింది, ఇది IDRBT యొక్క స్వంత సేకరణ హ్యాండ్‌బుక్‌ను ఉల్లంఘించింది. IKCON ఉద్యోగులు 22 ఖాతాలను కలిగి ఉన్నారు, వాటిలో 3 గ్లోబల్ సూపర్ అడ్మిన్ యాక్సెస్‌తో ఉన్నాయి.",
            "callout_text": "ఈ దుర్బలత్వం CERT-Inకు నివేదించబడింది (జూన్ 8, 05:30 UTC) మరియు IDRBT ద్వారా జూన్ 25, 2026న పరిష్కరించబడినట్లు ధృవీకరించబడింది. బహిర్గతమైన ఎండ్‌పాయింట్లు ఇకపై యాక్సెస్ చేయలేవు.",
            "eli5": ".bank.in ను RBI ప్రతి బ్యాంక్ వెబ్‌సైట్‌పై ఉంచిన ప్రత్యేక తాళంగా భావించండి, తద్వారా అది నిజమైనదని మీకు తెలుస్తుంది. ఈ దర్యాప్తులో ఆ తాళం తయారీదారు యొక్క స్వంత సిస్టమ్ అన్ని తాళపు చెవులను లీక్ చేస్తున్నట్లు కనుగొనబడింది — మరియు నివేదిక ఎలా, ఎందుకు ముఖ్యమైనది మరియు ఇంకా ఏమి విరిగిపోయిందో వివరిస్తుంది.",
            "h2_data": "ఓపెన్ డేటా",
            "h2_links": "లింక్‌లు",
            ...
            "about_title": "CashlessConsumer",
            "about_text": "డిజిటల్ పేమెంట్స్ పరిశ్రమను ట్రాక్ చేసే వినియోగదారుల సమాహారం, సరసమైన క్యాష్‌లెస్ సమాజం వైపు అవగాహన వనరులు, సాంకేతిక విశ్లేషణ, ఓపెన్ డేటా మరియు విధాన ఇన్‌పుట్‌లను ఉత్పత్తి చేస్తుంది. ఈ దర్యాప్తు స్థిరమైన పద్దతిని అనుసరిస్తుంది: పబ్లిక్ రికార్డులు, OSINT, RTI మరియు బాధ్యతాయుతమైన బహిర్గతం — హ్యాకింగ్ లేదు, దొంగిలించబడిన డేటా లేదు, ప్రతికూల టెక్నిక్‌లు లేవు.",
            "about_ref": "మునుపటి పని: KillerLoanApps · BFIL Consent Scam · Fintech Governance RTI Program",
            "about_links": "cashlessconsumer.in · Newsletter · GitHub",
    ...
    "gu": {
            ...
            "byline": "<strong>CashlessConsumer</strong> · <span class=\"date\">28 જૂન 2026</span>",
            "subtitle": "33+ અનધિકૃત API એન્ડપોઇન્ટ્સે એક વર્ષથી વધુ સમય સુધી 5,576 બેંક કર્મચારીઓના ક્રેડેન્શિયલ્સ ખુલ્લા મૂક્યા.",
            "lead": "ભારતનું .bank.in એ RBIનું ફ્લેગશિપ એન્ટી-ફિશિંગ પહેલ હતું — એક ડોમેન સફિક્સ જે નાગરિકો વિશ્વાસ કરી શકે તેવું ટ્રસ્ટ એન્કર બનવાનું હતું. પરંતુ આ ડોમેન્સ જારી કરતા પોર્ટલે દરેક ક્રેડેન્શિયલ લીક કરી દીધું.",
            "p1": "IDRBT ડોમેન રજિસ્ટ્રેશન પોર્ટલે 33+ અનધિકૃત એન્ડપોઇન્ટ્સ ખુલ્લા મૂક્યા. curl ધરાવતી કોઈપણ વ્યક્તિ 5576 બેંક કર્મચારીઓના bcrypt હેશ, મોબાઇલ નંબર, ઇમેઇલ અને IP મેળવી શકતી હતી.",
            "p2": "IKCON ટેક્નોલોજીસ દ્વારા જાહેર ટેન્ડર વિના બનાવવામાં આવેલ પોર્ટલ, જે IDRBTના પ્રોક્યોરમેન્ટ નિયમોનું ઉલ્લંઘન કરે છે. IKCON પાસે 3 સુપર એડમિન સહિત 22 એકાઉન્ટ હતા.",
            "callout_text": "CERT-In ને 8 જૂનના રોજ નબળાઈની જાણ કરવામાં આવી અને 25 જૂન 2026ના રોજ સુધારવામાં આવી. એન્ડપોઇન્ટ્સ હવે સુલભ નથી.",
            "eli5": ".bank.in ને RBI દ્વારા બેંક વેબસાઇટ્સ પર મૂકાયેલા ખાસ તાળા તરીકે વિચારો. તાળા બનાવનારની પોતાની સિસ્ટમ બધી ચાવીઓ લીક કરી રહી હતી.",
            "h2_data": "ઓપન ડેટા",
            "h2_links": "લિંક્સ",
            "dl_report": "📄 સંપૂર્ણ રિપોર્ટ ડાઉનલોડ કરો (PDF)",
            "dl_open": "📦 ઓપન ડેટા અને ડેટાસેટ્સ",
            "ln_code": "💻 સોર્સ કોડ",
            "ln_audit": "🔍 દૈનિક ઑડિટ ફીડ",
            "ln_archive": "📋 પુરાવા આર્કાઇવ",
            "about_title": "CashlessConsumer",
            "about_text": "ભારતમાં ડિજિટલ ચુકવણીઓ પર નજર રાખતું ગ્રાહક સમૂહ. જાગૃતિ સંસાધનો, ટેક્નિકલ વિશ્લેષણ, ઓપન ડેટા અને નીતિ ઇનપુટ્સ તૈયાર કરે છે. જાહેર રેકોર્ડ્સ, OSINT, RTI અને જવાબદાર જાહેરાતનો ઉપયોગ કરે છે.",
            "about_ref": "પાછલું કાર્ય: KillerLoanApps, BFIL Consent Scam, Fintech Governance RTI Program",
            "about_links": "cashlessconsumer.in ન્યૂઝલેટર GitHub",
            "footer": "જવાબદાર જાહેરાત સિદ્ધાંતો હેઠળ પ્રકાશિત. જૂન 2026. Srikanth L, CashlessConsumer દ્વારા રિપોર્ટ.",
            "label": "ગુજરાતી",
            "trans_d": "⚠️ AI-generated translation. English original is authoritative."
        },
    "ur": {
            "tag": "سیکیورٹی انویسٹی گیشن",
            "h1": "IDRBT .bank.in: ٹرسٹ اینکر سے ڈیٹا لیک تک",
            "byline": "<strong>CashlessConsumer</strong> · <span class=\"date\">28 جون 2026</span>",
            "subtitle": "33+ غیر تصدیق شدہ API اینڈ پوائنٹس نے 5,576 بینک ملازمین کی اسناد ایک سال سے زائد عرصے تک بے نقاب کیں۔",
            "lead": "ہندوستان کا .bank.in RBI کا فلیگ شپ اینٹی فشنگ اقدام تھا — ایک ڈومین سفیكس جو شہریوں کے لیے قابلِ اعتماد ٹرسٹ اینکر بننا تھا۔ مگر اس ڈومین کو جاری کرنے والے پورٹل نے تمام اسناد لیک کر دیں۔",
            "p1": "IDRBT ڈومین رجسٹریشن پورٹل نے 33+ غیر تصدیق شدہ اینڈ پوائنٹس بے نقاب کیے۔ curl والا کوئی بھی شخص 5576 بینک ملازمین کے bcrypt ہیشز، موبائل نمبرز، ای میلز اور IPs حاصل کر سکتا تھا۔",
            "p2": "یہ پورٹل IKCON Technologies نے بغیر عوامی ٹینڈر کے بنایا، جو IDRBT کے خریداری قوانین کی خلاف ورزی ہے۔ IKCON کے پاس 22 اکاؤنٹس تھے جن میں 3 سپر ایڈمن شامل تھے۔",
            "callout_text": "خامی CERT-In کو 8 جون کو رپورٹ کی گئی اور 25 جون 2026 کو ٹھیک کر دی گئی۔ اینڈ پوائنٹس اب قابلِ رسائی نہیں ہیں۔",
            "eli5": ".bank.in کو ایک خاص تالا سمجھیں جو RBI نے بینکوں کی ویب سائٹس پر لگایا۔ اس تالے بنانے والے کا اپنا سسٹم تمام چابیاں لیک کر رہا تھا۔",
            "h2_data": "اوپن ڈیٹا",
            "h2_links": "لنکس",
            "dl_report": "📄 مکمل رپورٹ ڈاؤن لوڈ کریں (PDF)",
            "dl_open": "📦 اوپن ڈیٹا اور ڈیٹاسیٹس",
            "ln_code": "💻 سورس کوڈ",
            "ln_audit": "🔍 یومیہ آڈٹ فیڈ",
            "ln_archive": "📋 ثبوت آرکائیو",
            "about_title": "CashlessConsumer",
            "about_text": "ایک صارفین کا اجتماعی گروپ جو ہندوستان میں ڈیجیٹل ادائیگیوں پر نظر رکھتا ہے۔ آگاہی وسائل، تکنیکی تجزیہ، اوپن ڈیٹا اور پالیسی ان پٹ تیار کرتا ہے۔ عوامی ریکارڈز، OSINT، RTI اور ذمہ دارانہ انکشاف استعمال کرتا ہے۔",
            ...
            "footer": "ذمہ دارانہ انکشاف کے اصولوں کے تحت شائع کیا گیا۔ جون 2026۔ رپورٹ از Srikanth L، CashlessConsumer۔",
            "label": "اردو",
            "trans_d": "⚠️ AI-generated translation. English original is authoritative."
        },
    "kn": {
            "tag": "ಭದ್ರತಾ ತನಿಖೆ",
            "h1": "IDRBT .bank.in: ನಂಬಿಕೆಯ ಆಧಾರಸ್ತಂಭದಿಂದ ಡೇಟಾ ಸೋರಿಕೆಗೆ",
            "byline": "<strong>CashlessConsumer</strong> · <span class=\"date\">28 ಜೂನ್ 2026</span>",
            "subtitle": "33+ ದೃಢೀಕರಣವಿಲ್ಲದ API ಎಂಡ್‌ಪಾಯಿಂಟ್‌ಗಳು ಒಂದು ವರ್ಷಕ್ಕೂ ಹೆಚ್ಚು ಕಾಲ 5,576 ಬ್ಯಾಂಕ್ ಉದ್ಯೋಗಿಗಳ ರುಜುವಾತುಗಳನ್ನು ಬಹಿರಂಗಪಡಿಸಿದವು.",
            "lead": "ಭಾರತದ .bank.in ಆರ್ಬಿಐನ ಪ್ರಮುಖ ಆಂಟಿ-ಫಿಶಿಂಗ್ ಉಪಕ್ರಮವಾಗಿತ್ತು — ನಾಗರಿಕರು ನಂಬಬಹುದಾದ ವಿಶ್ವಾಸದ ಆಧಾರಸ್ತಂಭವಾಗಿ ಉದ್ದೇಶಿಸಲಾದ ಡೊಮೇನ್ ಸಫಿಕ್ಸ್. ಬದಲಿಗೆ ಈ ಡೊಮೇನ್‌ಗಳನ್ನು ನೀಡುವ ಪೋರ್ಟಲ್ ಎಲ್ಲಾ ರುಜುವಾತುಗಳನ್ನು ಸೋರಿಕೆ ಮಾಡಿತು.",
            "p1": "IDRBT ಡೊಮೇನ್ ನೋಂದಣಿ ಪೋರ್ಟಲ್ 33+ ದೃಢೀಕರಣವಿಲ್ಲದ ಎಂಡ್‌ಪಾಯಿಂಟ್‌ಗಳನ್ನು ಬಹಿರಂಗಪಡಿಸಿತು. curl ಹೊಂದಿರುವ ಯಾರಾದರೂ 5,576 ಬ್ಯಾಂಕ್ ಉದ್ಯೋಗಿಗಳ bcrypt ಹ್ಯಾಶ್‌ಗಳು, ಮೊಬೈಲ್ ಸಂಖ್ಯೆಗಳು, ಇಮೇಲ್‌ಗಳು ಮತ್ತು IPಗಳನ್ನು ಪಡೆಯಬಹುದಿತ್ತು.",
            "p2": "ಸಾರ್ವಜನಿಕ ಟೆಂಡರ್ ಇಲ್ಲದೆ IKCON ಟೆಕ್ನಾಲಜೀಸ್ ನಿರ್ಮಿಸಿದ ಪೋರ್ಟಲ್, IDRBT ಸಂಗ್ರಹಣೆ ನಿಯಮಗಳನ್ನು ಉಲ್ಲಂಘಿಸಿದೆ. IKCON 3 ಸೂಪರ್ ಅಡ್ಮಿನ್ ಸೇರಿದಂತೆ 22 ಖಾತೆಗಳನ್ನು ಹೊಂದಿತ್ತು.",
            "callout_text": "ದುರ್ಬಲತೆಯನ್ನು ಜೂನ್ 8 ರಂದು CERT-In ಗೆ ವರದಿ ಮಾಡಲಾಯಿತು ಮತ್ತು ಜೂನ್ 25, 2026 ರಂದು ಸರಿಪಡಿಸಲಾಯಿತು. ಎಂಡ್‌ಪಾಯಿಂಟ್‌ಗಳು ಇನ್ನು ಪ್ರವೇಶಿಸಲಾಗುವುದಿಲ್ಲ.",
            "eli5": ".bank.in ಅನ್ನು RBI ಬ್ಯಾಂಕ್ ವೆಬ್‌ಸೈಟ್‌ಗಳ ಮೇಲೆ ಹಾಕಿದ ವಿಶೇಷ ಬೀಗ ಎಂದು ಭಾವಿಸಿ. ಆ ಬೀಗ ತಯಾರಕನ ಸ್ವಂತ ವ್ಯವಸ್ಥೆಯೇ ಎಲ್ಲಾ ಕೀಗಳನ್ನು ಸೋರಿಕೆ ಮಾಡುತ್ತಿತ್ತು.",
            "h2_data": "ಮುಕ್ತ ಡೇಟಾ",
            "h2_links": "ಲಿಂಕ್‌ಗಳು",
            "dl_report": "📄 ಸಂಪೂರ್ಣ ವರದಿಯನ್ನು ಡೌನ್ಲೋಡ್ ಮಾಡಿ (PDF)",
            "dl_open": "📦 ಮುಕ್ತ ಡೇಟಾ ಮತ್ತು ಡೇಟಾಸೆಟ್‌ಗಳು",
            "ln_code": "💻 ಮೂಲ ಕೋಡ್",
            "ln_audit": "🔍 ದೈನಿಕ ಆಡಿಟ್ ಫೀಡ್",
            "ln_archive": "📋 ಸಾಕ್ಷ್ಯ ಆರ್ಕೈವ್",
            "about_title": "CashlessConsumer",
            "about_text": "ಭಾರತದಲ್ಲಿ ಡಿಜಿಟಲ್ ಪಾವತಿಗಳನ್ನು ಟ್ರ್ಯಾಕ್ ಮಾಡುವ ಗ್ರಾಹಕರ ಸಮೂಹ. ಜಾಗೃತಿ ಸಂಪನ್ಮೂಲಗಳು, ತಾಂತ್ರಿಕ ವಿಶ್ಲೇಷಣೆ, ಮುಕ್ತ ಡೇಟಾ ಮತ್ತು ನೀತಿ ಇನ್‌ಪುಟ್‌ಗಳನ್ನು ನಿರ್ಮಿಸುತ್ತದೆ. ಸಾರ್ವಜನಿಕ ದಾಖಲೆಗಳು, OSINT, RTI ಮತ್ತು ಜವಾಬ್ದಾರಿಯುತ ಬಹಿರಂಗಪಡಿಸುವಿಕೆಯನ್ನು ಬಳಸುತ್ತದೆ.",
            "about_ref": "ಹಿಂದಿನ ಕೆಲಸ: KillerLoanApps, BFIL Consent Scam, Fintech Governance RTI Program",
            "about_links": "cashlessconsumer.in · ಸುದ್ದಿಪತ್ರ · GitHub",
            "footer": "ಜವಾಬ್ದಾರಿಯುತ ಬಹಿರಂಗಪಡಿಸುವಿಕೆ ತತ್ವಗಳ ಅಡಿಯಲ್ಲಿ ಪ್ರಕಟಿಸಲಾಗಿದೆ. ಜೂನ್ 2026. ವರದಿ: Srikanth L, CashlessConsumer.",
            "label": "ಕನ್ನಡ",
            "trans_d": "⚠️ AI-generated translation. English original is authoritative."
        },
}
